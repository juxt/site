...
----
<1> Some arbitary data associated with this user
<2> Here, we'll assign Malcolm to two roles. However, these roles are _not_ a
Site concept. You can design whatever access control scheme fits your
requirements, referencing data in your Documents from rules you write in
Actions.
====
