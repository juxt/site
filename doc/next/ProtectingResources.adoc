...
As per our Action's rules, we'll need to grant a Permission so that our REPL user can perform it:
...
Copy the code snippets in <<creating-an-action-to-create-a-protected-resource>>
