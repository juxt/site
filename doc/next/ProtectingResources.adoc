...
[source,clojure]
----
include::../../test/juxt/demo.clj[tag=create-action-put-immutable-private-resource!,indent=0]
----
...
[source,clojure]
----
include::../../test/juxt/demo.clj[tag=grant-permission-to-put-immutable-private-resource!,indent=0]
----
...
----
include::../../test/juxt/demo.clj[tag=create-action-get-private-resource,indent=0]
----
...
----
include::../../test/juxt/demo.clj[tag=grant-permission-to-get-private-resource!,indent=0]
----
...
[source,clojure]
----
include::../../test/juxt/demo.clj[tag=create-immutable-private-resource!,indent=0]
----
