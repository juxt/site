...
. A Cookie Scope that redirects unauthenticated requests when necessary. This is
added in <<create-cookie-scope>>.

. A login form that will be shown to the User, allowing them to
authenticate. This is created in <<create-login-form>>.

. A resource that can receive the POST request that occurs when a User submits
the login form.
...
[source,clojure]
----
include::../../test/juxt/book.clj[tag=create-resource-protected-by-cookie-scope!,indent=0]
----
====
...
[source,clojure]
----
include::../../test/juxt/book.clj[tag=grant-permission-to-resource-protected-by-cookie-scope!,indent=0]
----
====

[[create-cookie-scope]]
== Create the cookie scope

.Creating the cookie scope
====
[source,clojure]
----
include::../../test/juxt/book.clj[tag=create-cookie-scope!,indent=0]
----
====
...
[source,clojure]
----
include::../../test/juxt/book.clj[tag=create-login-form!,indent=0]
----
====
