...
(deftest triggers-test
  ...
  (submit-and-await!
   [[:xtdb.tx/put access-all-apis]
    ...
    [:xtdb.tx/put {:xt/id "https://example.org/users/sue"
                   ::site/type "User"
                   ::site/description "Sue should receive an email on every alert"
                   :email "sue@example.org"
                   ::email? true}]
    [:xtdb.tx/put {:xt/id "https://example.org/users/brian"
                   ::site/type "User"
                   ::site/description "Brian doesn't want emails"
                   :email "brian@example.org"
                   ::email? false}]
    [:xtdb.tx/put {:xt/id "https://example.org/roles/service-manager"
                   ::site/type "Role"
                   ::site/description "A service manager"}]
    [:xtdb.tx/put {:xt/id "https://example.org/users/sue-is-a-service-manager"
                   ::site/type "UserRoleMapping"
                   ::user "https://example.org/users/sue"
                   ::role "https://example.org/roles/service-manager"}]
    [:xtdb.tx/put {:xt/id "https://example.org/users/brian-is-a-service-manager"
                   ::site/type "UserRoleMapping"
