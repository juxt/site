...
[source,clojure]
----
include::../../test/juxt/book.clj[tag=create-action-put-api-resource!,indent=0]
----

[source,clojure]
----
include::../../test/juxt/book.clj[tag=grant-permission-to-invoke-action-put-api-resource!,indent=0]
----
====
...
[source,clojure]
----
include::../../test/juxt/book.clj[tag=create-action-list-identities!,indent=0]
----
