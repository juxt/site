...
<2> Here, we'll assign Malcolm to two roles. However, these roles are _not_ a Site concept. You can design whatever access control scheme fits your requirements.
====
