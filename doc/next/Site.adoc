...
This part contains all the information you need to authenticate users.

[[ch-protection-spaces]]
include::ProtectionSpaces.adoc[leveloffset=+1]
...
Then, in <<ch-applications>>, we create Applications registered against the Authorization Server that it
can authorize.
