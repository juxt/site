...
[source,clojure]
----
include::../../test/juxt/book.clj[tag=install-user!,indent=0]
----
...
.A possible relationship between a User, Subject and Identity
[[user-model]]
====
...
[source,clojure]
----
include::../../test/juxt/book.clj[tag=install-subject!,indent=0]
----
====
