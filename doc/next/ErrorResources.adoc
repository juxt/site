...
[source,clojure]
----
include::../../test/juxt/demo.clj[tag=create-action-put-error-resource!,indent=0]
----

[source,clojure]
----
include::../../test/juxt/demo.clj[tag=grant-permission-to-put-error-resource!,indent=0]
----

[source,clojure]
----
include::../../test/juxt/demo.clj[tag=put-unauthorized-error-resource!,indent=0]
----

[source,clojure]
----
include::../../test/juxt/demo.clj[tag=put-unauthorized-error-representation-for-html!,indent=0]
----
====
...
[source,clojure]
----
include::../../test/juxt/demo.clj[tag=put-unauthorized-error-representation-for-html-with-login-link!,indent=0]
----
====
