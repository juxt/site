...
import { DefaultProps, MantineColor, ClassNames, MantineSize, MantineNumberSize } from '@mantine/styles';
import useStyles from './Step.styles';
export declare type StepStylesNames = ClassNames<typeof useStyles>;
