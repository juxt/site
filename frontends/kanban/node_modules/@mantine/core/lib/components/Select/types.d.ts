...
export declare type BaseSelectStylesNames = InputStylesNames | InputWrapperStylesNames | SelectItemsStylesNames | SelectDropdownStylesNames;
export declare type BaseSelectProps = InputWrapperBaseProps & InputBaseProps & Omit<React.ComponentPropsWithoutRef<'input'>, 'value' | 'onChange' | 'size' | 'defaultValue'>;
