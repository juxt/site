...
var ReplaceAroundStep2 = class extends Step {
...
function setBlockType(tr, from, to, type, attrs) {
  ...
  tr.doc.nodesBetween(from, to, (node, pos) => {
    if (node.isTextblock && !node.hasMarkup(type, attrs) && canChangeType(tr.doc, tr.mapping.slice(mapFrom).map(pos), type)) {
      ...
      tr.step(new ReplaceAroundStep2(startM, endM, startM + 1, endM - 1, new Slice(Fragment.from(type.create(attrs, null, node.marks)), 0, 0), 1, true));
      return false;
    }
  });
}
...
function replaceStep2(doc2, from, to = from, slice = Slice.empty) {
...
var Transform = class {
  ...
  replace(from, to = from, slice = Slice.empty) {
    let step = replaceStep2(this.doc, from, to, slice);
    if (step)
      this.step(step);
    return this;
  }
...
//# sourceMappingURL=chunk-NLKFJLJH.js.map
